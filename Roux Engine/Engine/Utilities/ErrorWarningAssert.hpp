//-----------------------------------------------------------------------------------------------
// Taken from the Gypsy engine, written by Brian (Squirrel) Eiserloh. Permission to use granted by Mr. Eiserloh. 
...
// #define FATAL_ASSERTION( condition, errorMessageText )		// Same as FATAL_GUARANTEE, but removed if ROUX_DISABLE_ASSERTS is #defined
...
// #define RECOVERABLE_ASSERTION( condition, errorMessageText )	// Same as RECOVERABLE_GUARANTEE, but removed if ROUX_DISABLE_ASSERTS is #defined
// 
...
// FATAL_ASSERTION
//
// Removed if ROUX_DISABLE_ASSERTS is enabled, typically in a Final build configuration.
// Triggers if condition is false.
// Depending on the platform, this typically:
//	- Logs a warning to the console and/or log file
//	- Opens an error/message dialogue box
...
//	- Shuts down the app
//
#if defined( ROUX_DISABLE_ASSERTS )
